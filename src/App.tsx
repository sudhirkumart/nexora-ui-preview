...
import { AskNexoraAuthProvider } from './auth/AskNexoraAuthContext'
import { AskNexoraProtectedRoute } from './components/AskNexoraProtectedRoute'
import { AppShell } from './components/AppShell'
import { pageContent } from './data/mockData'
import { AboutPreviewPage } from './pages/AboutPreviewPage'
import { AskNexoraLoginPage } from './pages/AskNexoraLoginPage'
import { AskNexoraPage } from './pages/AskNexoraPage'
    ...
    <AskNexoraAuthProvider>
      <AppShell>
        <Routes>
          ...
          <Route path="/ask-nexora/login" element={<AskNexoraLoginPage />} />
          <Route element={<AskNexoraProtectedRoute />}>
            <Route path="/ask-nexora" element={<AskNexoraPage />} />
          </Route>
